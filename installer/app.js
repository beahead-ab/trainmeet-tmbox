...
function station() {
  ...
  return heading('Koppla boxen till en station', 'Nu tar TrainMeet Server över. Det är servern som har träffen, tidtabellen och alla trafikregler — boxen är dess klient.') +
    ...
    <div class="notice warning"><strong>Gemensam trafiklogik måste finnas i servern.</strong> Server 1.4.1 har NodeMCU-tilldelningsrättningen men inte hela samkörningen mellan 8266, ESP32 och TKL. Den finns ännu på utvecklingsgrenen <code>codex/shared-station-traffic</code>. Använd en kontrollerad testserver tills den är släppt och provkörd. <a href="https://github.com/beahead-ab/trainmeet-server/blob/codex/shared-station-traffic/docs/shared-traffic.md" target="_blank" rel="noopener noreferrer">Läs kompatibilitetsnoteringen ↗</a></div>
